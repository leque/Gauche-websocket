;;
;; Package Gauche-websocket
;;

(define-gauche-package "Gauche-websocket"
  ;; 
  :version "1.0"
  ...
  ;; Homepage URL, if any.
  ; :homepage "http://example.com/Gauche-websocket/"

  ;; Repository URL, e.g. github
  ; :repository "http://example.com/Gauche-websocket.git"
  )
